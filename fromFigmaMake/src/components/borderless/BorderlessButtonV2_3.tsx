...
interface BorderlessButtonV2_3Props {
  icon: LucideIcon;
...
// ==================== V2.3: Enhanced Press State with Scale ====================
// brightness: 1.15 → 1.5 (50% brighter)
// scale: add 0.96 (4% smaller on press)
...
export function BorderlessButtonV2_3({
  ...
  return (
    ...
    >
      ...
      {/* Layer 4: Button container + Icon + Enhanced press state */}
      <motion.button
        onClick={onClick}
        ...
        onMouseDown={() => {
          setIsPressed(true);
          console.log('Button pressed (v2.3)!');
        }}
        onMouseUp={() => {
          setIsPressed(false);
          console.log('Button released (v2.3)!');
        }}
        animate={{
          // ⭐⭐⭐ Enhanced: brightness 1.15 → 1.5 (50% brighter)
          filter: isPressed ? 'brightness(1.5)' : 'brightness(1.0)',
          
          // ⭐⭐⭐ New: scale 0.96 (4% smaller on press)
