...
interface BorderlessCardV2_3Props {
  title: string;
  subtitle?: string;
  icon?: LucideIcon;
...
// ==================== V2.3: v2.0 + Scale on Press ====================
// Same as v2.0 but add scale: 0.96 on press
...
export function BorderlessCardV2_3({
  ...
  return (
    ...
    >
      ...
      {/* Layer 4: Main container + Enhanced press state */}
      <motion.div
        animate={{
          // Same brightness as v2.0: 1.15
          filter: isPressed ? 'brightness(1.15)' : 'brightness(1.0)',
          
          // ⭐⭐⭐ New in v2.3: scale 0.96 (4% smaller on press)
